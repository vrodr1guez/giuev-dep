...
function CompanyPage() {
    return (<div className="min-h-screen bg-dots-indigo">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="card-premium p-8 card-3d">
              ...
              <div className="p-4 bg-blue-50 rounded-lg">
                <lucide_react_1.Leaf className="h-8 w-8 text-blue-600 mb-2"/>
            ...
            <div className="card-premium p-8 card-3d">
              ...
              <div className="p-4 bg-green-50 rounded-lg">
                <lucide_react_1.Award className="h-8 w-8 text-green-600 mb-2"/>
                <p className="text-gray-800 font-medium">
      ...
      <div className="py-16 px-6 bg-white">
        ...
        ].map(function (leader, index) { return (<div key={index} className="card-premium p-6 hover-scale">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-6">
                <div className="flex items-start glass-effect p-4 rounded-lg">
                  <lucide_react_1.Home className="h-5 w-5 text-blue-600 mr-3 mt-1"/>
                  <div>
              ...
              <div className="relative w-full max-w-md aspect-square">
                <div className="absolute inset-0 card-premium rounded-xl overflow-hidden">
                  <div className="w-full h-full bg-blue-100 flex items-center justify-center">
                    <lucide_react_1.Map className="h-32 w-32 text-blue-300"/>
                  </div>
                </div>
