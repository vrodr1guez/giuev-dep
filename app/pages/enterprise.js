...
var EnterpriseFeatures_1 = require("../components/enterprise/EnterpriseFeatures");
            ...
            <div className="card-premium p-6 text-center card-3d">
              <div className="flex justify-center mb-4">
                <div className="p-3 rounded-full bg-blue-50">
                  <lucide_react_1.Settings className="h-6 w-6 text-blue-600"/>
                </div>
              </div>
            ...
            <div className="card-premium p-6 text-center card-3d">
              <div className="flex justify-center mb-4">
                <div className="p-3 rounded-full bg-green-50">
                  <lucide_react_1.Server className="h-6 w-6 text-green-600"/>
                </div>
              </div>
            ...
            <div className="card-premium p-6 text-center card-3d">
              <div className="flex justify-center mb-4">
                <div className="p-3 rounded-full bg-amber-50">
                  <lucide_react_1.BarChart className="h-6 w-6 text-amber-600"/>
                </div>
              </div>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <lucide_react_1.Shield className="h-6 w-6 text-blue-600 mr-3 mt-1"/>
                  <div>
            ...
            <div className="flex-1 flex justify-center">
              <div className="glass-effect p-8 rounded-2xl w-full max-w-md h-64 flex items-center justify-center">
                <lucide_react_1.Shield className="h-32 w-32 text-blue-500 opacity-20"/>
              </div>
            </div>
          </div>
        </div>
