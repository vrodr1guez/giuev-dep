...
import { ArrowRight, Calendar, User, BarChart } from 'lucide-react';
...
const CaseStudyCard: React.FC<CaseStudyCardProps> = ({ 
  title, company, industry, image, date, author, excerpt, link 
}) => {
  return (
    <div className="card-premium overflow-hidden hover-scale">
...
const ResultBox: React.FC<ResultBoxProps> = ({ title, value, unit, improvement, icon }) => {
  return (
          ...
          <div className="glass-effect rounded-xl overflow-hidden">
            <div className="flex flex-col lg:flex-row">
              <div className="lg:w-1/2">
                <img 
                  src="https://images.unsplash.com/photo-1621797064678-39af97643d32?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fGVsZWN0cmljJTIwZGVsaXZlcnklMjB2YW58ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60" 
                  alt="Global Express Logistics Fleet" 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <ResultBox 
              ...
              value="28"
              unit="%"
              improvement="Based on 50+ deployments"
            ...
            <ResultBox 
              ...
              value="142K"
              unit=" tons"
              improvement="Equivalent to planting 2.3M trees"
              icon={<div className="text-green-600 text-2xl">🌿</div>}
            />
            
            <ResultBox 
              title="Fleet Uptime Improvement"
              value="23"
              unit="%"
              improvement="Through predictive maintenance"
              icon={<div className="text-purple-600 text-2xl">⚡</div>}
            />
            
            <ResultBox 
              title="Avg. ROI Timeframe"
              value="18"
              unit=" months"
              improvement="Faster than industry average"
              icon={<div className="text-amber-600 text-2xl">📈</div>}
            />
          </div>
        </div>
      </div>
      ...
      <div className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <CaseStudyCard 
              title="Municipal Fleet Transformation"
              company="City of Greenfield"
              industry="Government"
              image="https://images.unsplash.com/photo-1631758301707-04197e23c08e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8ZWxlY3RyaWMlMjBjaXR5JTIwdmVoaWNsZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60"
              date="June 2023"
              author="Mark Johnson"
              excerpt="How a mid-sized city electrified their municipal fleet and saved taxpayers $1.2M annually while reducing emissions by 85%."
              link="#"
            />
            ...
            <CaseStudyCard 
              ...
              industry="Retail"
              image="https://images.unsplash.com/photo-1619551734325-81aaf323686c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTV8fGVsZWN0cmljJTIwdmFufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60"
              date="April 2023"
              author="Sarah Williams"
              excerpt="This e-commerce delivery company implemented our solution across 200+ vehicles, improving delivery efficiency by 32%."
              link="#"
            />
            ...
            <CaseStudyCard 
              ...
              industry="Education"
              image="https://images.unsplash.com/photo-1546447147-3fc7a24bc1c4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8c2Nob29sJTIwYnVzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60"
              date="March 2023"
              author="Robert Chen"
              excerpt="How a forward-thinking school district electrified their bus fleet, improved air quality, and created $400k in annual savings."
              link="#"
            />
            
            <CaseStudyCard 
              title="Service Fleet Optimization"
              company="Sunshine Utilities"
              industry="Utilities"
              image="https://images.unsplash.com/photo-1579896902689-3befbdc8623f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8dXRpbGl0eSUyMHRydWNrfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60"
              date="February 2023"
              author="Jennifer Lee"
              excerpt="A regional utility provider transitioned their service fleet to EVs, reducing operating costs while improving service response times."
              link="#"
            />
            
            <CaseStudyCard 
              title="Campus Transportation Revolution"
              company="Pacific University"
              industry="Education"
              image="https://images.unsplash.com/photo-1607237138185-eedd9c632b0b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y29sbGVnZSUyMGNhbXB1c3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60"
              date="January 2023"
              author="David Wong"
              excerpt="How a large university campus electrified their shuttle system and built a charging infrastructure that doubles as a research facility."
              link="#"
            />
            
            <CaseStudyCard 
              title="Rental Fleet Transition"
              company="GreenCar Rentals"
              industry="Transportation"
              image="https://images.unsplash.com/photo-1580273916550-e323be2ae537?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTR8fGV2JTIwcmVudGFsfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60"
              date="December 2022"
              author="Amanda Taylor"
              excerpt="This forward-thinking car rental company transformed customer experience with an all-electric fleet and innovative charging solutions."
              link="#"
            />
          </div>
        </div>
