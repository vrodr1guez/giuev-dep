...
import { Check, Info as HelpCircle } from 'lucide-react';
...
const PricingTier: React.FC<PricingTierProps> = ({ 
  ...
  return (
    <div className={`card-premium p-8 ${popular ? 'border-2 border-blue-500 shadow-xl' : ''} hover-scale`}>
      {popular && (
      ...
      <div className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <PricingTier 
              name="Starter"
              price={billingCycle === 'monthly' ? '$1,995' : '$1,596'}
              description="Perfect for small fleets just beginning their electrification journey."
              features={[
                "Up to 25 vehicles",
            ...
            <PricingTier 
              name="Professional"
              price={billingCycle === 'monthly' ? '$3,995' : '$3,196'}
              description="Ideal for growing fleets with more advanced management needs."
              features={[
                "Up to 100 vehicles",
            ...
            <PricingTier 
              name="Enterprise"
              price="Custom"
              description="Tailored solutions for large-scale fleet operations with complex requirements."
              features={[
                "Unlimited vehicles",
                    ...
                    <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      <td className="px-6 py-4 border-b border-gray-200 font-medium">
                        <div className="flex items-center">
                          {row.feature}
                          <HelpCircle className="h-4 w-4 text-gray-400 ml-2 tooltip" data-tooltip={`Details about ${row.feature}`} />
                        </div>
                      </td>
