...
var SettingsPage = function () {
    return (<div className="p-6 space-y-6 bg-grid-blue">
      ...
      <tabs_1.Tabs defaultValue="general" className="mt-6">
        <tabs_1.TabsList className="bg-white shadow-sm rounded-lg p-1 mb-4">
          <tabs_1.TabsTrigger value="general" className="rounded-md">General</tabs_1.TabsTrigger>
          <tabs_1.TabsTrigger value="users" className="rounded-md">User Management</tabs_1.TabsTrigger>
          <tabs_1.TabsTrigger value="connected" className="rounded-md">Connected Services</tabs_1.TabsTrigger>
          <tabs_1.TabsTrigger value="api" className="rounded-md">API Management</tabs_1.TabsTrigger>
          <tabs_1.TabsTrigger value="data" className="rounded-md">Data & Backups</tabs_1.TabsTrigger>
        </tabs_1.TabsList>
        
        <tabs_1.TabsContent value="general" className="card-premium p-6 rounded-lg">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
              ...
              <div className="md:col-span-2">
                <input id="orgName" type="text" className="input-field" defaultValue="GIU EV Charging Infrastructure"/>
              </div>
            </div>
              ...
              <div className="md:col-span-2">
                <div className="flex items-center space-x-4">
                  <label className="flex items-center space-x-2">
                    <input type="radio" name="distanceUnit" value="miles" defaultChecked className="h-4 w-4 text-blue-600 focus:ring-blue-500"/>
                    <span>Miles</span>
                  </label>
                  <label className="flex items-center space-x-2">
                    <input type="radio" name="distanceUnit" value="kilometers" className="h-4 w-4 text-blue-600 focus:ring-blue-500"/>
        ...
        <tabs_1.TabsContent value="connected" className="card-premium p-6 rounded-lg">
        ...
        <tabs_1.TabsContent value="api" className="card-premium p-6 rounded-lg">
        ...
        <tabs_1.TabsContent value="data" className="card-premium p-6 rounded-lg">
