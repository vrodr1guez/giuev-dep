...
import { LineChart, BarChart, PieChart, FileText, Calendar, Download } from 'lucide-react';
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <Tabs defaultValue="reports">
        <TabsList className="w-full max-w-md mb-6">
          <TabsTrigger value="reports" className="flex-1">Standard Reports</TabsTrigger>
          <TabsTrigger value="custom" className="flex-1">Custom Report Builder</TabsTrigger>
        </TabsList>
